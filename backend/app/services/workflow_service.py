...
def submit_request(db: Session, visitor_request: VisitorRequest, actor: User) -> VisitorRequest:
    ...
    if visitor_request.hospitality_request and visitor_request.hospitality_request.meal_required:
        send_food_dept_alert_email(db, visitor_request)
...
def apply_approval_action(
    ...
    if action_type == ApprovalActionType.APPROVE:
        ...
        send_visitor_rejection_email(db, visitor_request, reason=remarks)
